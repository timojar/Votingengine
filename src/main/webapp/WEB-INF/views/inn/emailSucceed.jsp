...
<h4><spring:message code="innovaatio.succeed.text1" /> <a href="hallitse"><spring:message code="innovaatio.succeed.link" /></a> <spring:message code="innovaatio.succeed.text2" /></h4>
</div>
